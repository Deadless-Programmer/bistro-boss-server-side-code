...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.mimqwr5.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0`;
...
async function run() {
  try {
    ...
    //     res
    //       .status(500)
    //       .send({ message: "An error occurred while fetching the menu item" });
    //   }
    // });
